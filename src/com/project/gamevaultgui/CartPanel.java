...
public class CartPanel extends JPanel {
    ...
    public void loadCart(int userId) {
        ...
        try {
            ...
            if (gamesInCart != null) { // Check if list is not null
             ...
             // Cart is empty, this is expected sometimes. No need for a dialog here, total will be $0.00.
             // JOptionPane.showMessageDialog(this, "Your cart is empty.", "Cart Status", JOptionPane.INFORMATION_MESSAGE); // Optional dialog
        }
        catch (Exception e) {
            ...
            e.printStackTrace();
             ...
             // Enable/disable checkout based on cart emptiness and user balance (more complex check)
    ...
    private void checkoutCart() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "An unexpected error occurred during checkout: " + e.getMessage(), "Checkout Error", JOptionPane.ERROR_MESSAGE);
            e.printStackTrace();
        }
    }
}